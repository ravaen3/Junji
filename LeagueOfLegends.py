    ...
    if entry.find("a"):
        if not entry.find("a").has_attr("class"):
            ...
            if character_name.endswith("/LoL"):
                characters[f"{character_name[:-4]} League_of_Legends"]=(Data.Character.Character(
                    character_name[:-4],
                    "League of Legends",
                    {"0":"https://cdn.discordapp.com/attachments/464939388061745163/1220845872041033758/image.png?ex=66106c52&is=65fdf752&hm=841f31f48a0838484d7d808b58838474defa1d1472d10aab17ae945caab39cc0&"}
                ))
